...
const int NETID_SWCAN2 = 68;
const int NETID_ETHERNET_DAQ = 69;
...
const int NETID_HW_COM_LATENCY_TEST = 512;
const int NETID_DEVICE_STATUS = 513;
const int NETID_ETHERNET2 = 520;
...
//Spy Status Bitfield 3 constants LIN
...
{
    uint32_t uiDevice;
    SRADPlutoSettings PlutoSettings;
} SRADPlutoSettingsPack;
...
//int _stdcall icsneoEnableNetworkComEx(void *hObject, int Network, int lEnable);
