...
typedef int(__stdcall* FINDDEVICES)(NeoDeviceEx* pNeoDeviceEx,int* pNumDevices,	unsigned int* deviceTypes,unsigned int numDeviceTypes,POptionsFindNeoEx* pOptionsFindNeoEx, unsigned long reserved);
...
typedef int (__stdcall *GETDEVICESETTINGS)(void* hObject, SDeviceSettings *pSettings, EPlasmaIonVnetChannel_t vnetSlot);
typedef int (__stdcall *SETDEVICESETTINGS)(void* hObject, SDeviceSettings *pSettings, int bSaveToEEPROM, EPlasmaIonVnetChannel_t vnetSlot);

typedef int (__stdcall *SETBITRATE)(void * hObject, int BitRate, int NetworkID);
typedef int (__stdcall *SETFDBITRATE)(void * hObject, int BitRate, int NetworkID);
...
typedef int(__stdcall* GETSETPHYSETTINGS)(size_t hObject, PhyRegPkt_t* PHYSettings, size_t size, size_t NumEntries);
...
typedef int  (__stdcall *ENABLEDOIPLINE)(void * hObject, bool bActivate);
...
typedef int (__stdcall *ENABLENETWORKCOMEX)(void * hObject, int network, int Enable);


//Basic Functions
extern FINDNEODEVICES icsneoFindNeoDevices;
extern FINDDEVICES icsneoFindDevices;
...
extern GETDEVICESETTINGS icsneoGetDeviceSettings;
extern SETDEVICESETTINGS icsneoSetDeviceSettings;
extern GETSETPHYSETTINGS icsneoReadWritePHYSettings;
...
extern ENABLEDOIPLINE icsneoEnableDOIPLine;
